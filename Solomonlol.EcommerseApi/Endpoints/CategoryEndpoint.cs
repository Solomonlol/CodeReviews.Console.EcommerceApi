...
namespace Solomonlol.EcommerseApi.Endpoints
{
    public static class CategoryEndpoint
    {
        public static void MapCategoryEndpoint(this WebApplication app)
        {
            ...
            //add attribute
            app.MapPost("api/v1/categories/{categoryName}/attributes", [Authorize(Roles = "Admin, Manager")] async (string categoryName, ProductAttributeDto attribute, IAttributeService service, CancellationToken ct) =>
            {
