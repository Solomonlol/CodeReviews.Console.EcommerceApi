...
namespace Solomonlol.EcommerseApi.Seeding
{
    public static class SeedDb
    {
        ...
        {
            if (!await db.ProductAttributes.AnyAsync(ct))
            {
                var attributes = new List<ProductAttribute>
                {
                    new() { CategoryId=(int)CategoryEnum.CPU, Name="Brand"},
                    new() { CategoryId=(int)CategoryEnum.CPU, Name="Core count"},
                    new() { CategoryId=(int)CategoryEnum.CPU, Name="Thread count"},
                    new() { CategoryId=(int)CategoryEnum.CPU, Name="Base Clock", Unit="GHz"},
                    new() { CategoryId=(int)CategoryEnum.CPU, Name="Max. Boost Clock", Unit="GHz"},
                    new() { CategoryId=(int)CategoryEnum.CPU, Name="TDP", Unit="W"},

                    new() { CategoryId=(int)CategoryEnum.GPU, Name="Brand"},
                    new() { CategoryId=(int)CategoryEnum.GPU, Name="Ray Tracing Cores"},
                    new() { CategoryId=(int)CategoryEnum.GPU, Name="Base Clock", Unit="GHz"},
                    new() { CategoryId=(int)CategoryEnum.GPU, Name="Boost Clock", Unit="GHz"},
                    new() { CategoryId=(int)CategoryEnum.GPU, Name="Standard Memory Config"},

                    new() { CategoryId=(int)CategoryEnum.Cases, Name="Brand"},
                    new() { CategoryId=(int)CategoryEnum.Cases, Name="Front interface"},
                    new() { CategoryId=(int)CategoryEnum.Cases, Name="Motherboard compatibility"},
                    new() { CategoryId=(int)CategoryEnum.Cases, Name="PSU max length"},
                    new() { CategoryId=(int)CategoryEnum.Cases, Name="CPU cooler max height"},

                    new() { CategoryId=(int)CategoryEnum.RAM, Name="Speed", Unit="MT/s"},
                    new() { CategoryId=(int)CategoryEnum.RAM, Name="Total (Kit) Capacity", Unit="GB"},
                    new() { CategoryId=(int)CategoryEnum.RAM, Name="CAS Latency"},
                    new() { CategoryId=(int)CategoryEnum.RAM, Name="DRAM Density", Unit="Gbit"},
                    new() { CategoryId=(int)CategoryEnum.RAM, Name="Brand"},

                    new() { CategoryId=(int)CategoryEnum.Monitors, Name="Display Size", Unit="Inches"},
                    new() { CategoryId=(int)CategoryEnum.Monitors, Name="Resolution"},
                    new() { CategoryId=(int)CategoryEnum.Monitors, Name="Aspect Ratio"},
                    new() { CategoryId=(int)CategoryEnum.Monitors, Name="Screen Surface"},
                    new() { CategoryId=(int)CategoryEnum.Monitors, Name="Brand"},

                    new() { CategoryId=(int)CategoryEnum.Headphones, Name="Brand"},
                    new() { CategoryId=(int)CategoryEnum.Headphones, Name="Color"},
                    new() { CategoryId=(int)CategoryEnum.Headphones, Name="Ear Placement"},
                    new() { CategoryId=(int)CategoryEnum.Headphones, Name="Form Factor"},
                    new() { CategoryId=(int)CategoryEnum.Headphones, Name="Impedance"},

                    new() { CategoryId=(int)CategoryEnum.Motherboards, Name="CPU Socket"},
                    new() { CategoryId=(int)CategoryEnum.Motherboards, Name="RAM Slots"},
                    new() { CategoryId=(int)CategoryEnum.Motherboards, Name="Brand"},
                    new() { CategoryId=(int)CategoryEnum.Motherboards, Name="Storage Connectors"},
                    new() { CategoryId=(int)CategoryEnum.Motherboards, Name="Form Factor"},

                    new() { CategoryId=(int)CategoryEnum.Fans, Name="Product Dimensions"},
                    new() { CategoryId=(int)CategoryEnum.Fans, Name="Brand"},
                    new() { CategoryId=(int)CategoryEnum.Fans, Name="Power Connector Type"},
                    new() { CategoryId=(int)CategoryEnum.Fans, Name="Voltage"},
                    new() { CategoryId=(int)CategoryEnum.Fans, Name="Maximum Rotational Speed"},

                    new() { CategoryId=(int)CategoryEnum.Mouse, Name="Brand"},
                    new() { CategoryId=(int)CategoryEnum.Mouse, Name="Color"},
                    new() { CategoryId=(int)CategoryEnum.Mouse, Name="Connectivity Technology"},
                    new() { CategoryId=(int)CategoryEnum.Mouse, Name="Special Feature"},
                    new() { CategoryId=(int)CategoryEnum.Mouse, Name="Movement Detection Technology"},

                    new() { CategoryId=(int)CategoryEnum.Keyboards, Name="Brand"},
                    new() { CategoryId=(int)CategoryEnum.Keyboards, Name="Connectivity Technology"},
                    new() { CategoryId=(int)CategoryEnum.Keyboards, Name="Recommended Uses For Product"},
                    new() { CategoryId=(int)CategoryEnum.Keyboards, Name="Special Feature"},
                    new() { CategoryId=(int)CategoryEnum.Keyboards, Name="Color"},

                    new() { CategoryId=(int)CategoryEnum.Laptops, Name="Brand"},
                    new() { CategoryId=(int)CategoryEnum.Laptops, Name="Model Name"},
                    new() { CategoryId=(int)CategoryEnum.Laptops, Name="Screen Size"},
                    new() { CategoryId=(int)CategoryEnum.Laptops, Name="CPU Model"},
                    new() { CategoryId=(int)CategoryEnum.Laptops, Name="Hard Disk Size"},
                    new() { CategoryId=(int)CategoryEnum.Laptops, Name="Memory Installed Size"},

                    new() { CategoryId=(int)CategoryEnum.SSD, Name="Brand"},
                    new() { CategoryId=(int)CategoryEnum.SSD, Name="Digital Storage Capacity"},
                    new() { CategoryId=(int)CategoryEnum.SSD, Name="Hard Disk Interface"},
                    new() { CategoryId=(int)CategoryEnum.SSD, Name="Connectivity Technology"},
                    new() { CategoryId=(int)CategoryEnum.SSD, Name="Form Factor"},

                    new() { CategoryId=(int)CategoryEnum.HDD, Name="Brand"},
                    new() { CategoryId=(int)CategoryEnum.HDD, Name="Digital Storage Capacity"},
                    new() { CategoryId=(int)CategoryEnum.HDD, Name="Hard Disk Interface"},
                    new() { CategoryId=(int)CategoryEnum.HDD, Name="Connectivity Technology"},
                    new() { CategoryId=(int)CategoryEnum.HDD, Name="Form Factor"},
                };
        ...
        private static async Task SeedCategory(ApplicationContext db, CancellationToken ct)
        {
            if(!await db.Categories.AnyAsync(ct))
            {
                ...
                {
                    new() { Name=$"{CategoryEnum.CPU}", Description="Category for personal computer processors"},
                    new() { Name=$"{CategoryEnum.GPU}", Description="Category for personal computer discrete vodeoadapters"},
                    new() { Name=$"{CategoryEnum.Cases}", Description="Category for personal computer cases"},
                    new() { Name=$"{CategoryEnum.RAM}", Description="Category for personal computer memory modules"},
                    new() { Name=$"{CategoryEnum.Monitors}", Description="Category for monitors"},
                    new() { Name=$"{CategoryEnum.Headphones}", Description="Category for headphones"},
                    new() { Name=$"{CategoryEnum.Motherboards}", Description="Category for personal computer motherboardes"},
                    new() { Name=$"{CategoryEnum.Fans}", Description="Category for personal computer cooling systems"},
                    new() { Name=$"{CategoryEnum.Mouse}", Description="Category for personal computer mouses"},
                    new() { Name=$"{CategoryEnum.Keyboards}", Description="Category for personal computer keyboardes"},
                    new() { Name=$"{CategoryEnum.Laptops}", Description="Category for laptops"},
                    new() { Name=$"{CategoryEnum.SSD}", Description="Category for SSD"},
                    new() { Name=$"{CategoryEnum.HDD}", Description="Category for HDD"},
                };
            ...
            if(!await db.Products.AnyAsync(ct))
            {
                ...
                var casesProducts = new List<Product>
                {
                    new() { Name="Zalman P30 Air",
                        CategoryId=(int)CategoryEnum.Cases,
                ...
                var ramProducts = new List<Product>
                {
                    new() { Name="ADATA XPG Lancer Blade RGB 2x16ГБ DDR5 6000",
                        CategoryId=(int)CategoryEnum.RAM,
                ...
                var monitorProducts = new List<Product>
                {
                    new() { Name="Xiaomi 2K Gaming Monitor G27Qi 2026",
                        CategoryId=(int)CategoryEnum.Monitors,
                ...
                var headphoneProducts = new List<Product>
                {
                    new() { Name="Anker Soundcore Space 2",
                        CategoryId=(int)CategoryEnum.Headphones,
                ...
                var motherboardsProduct = new List<Product>
                {
                    new() { Name="Sapphire Pure B850M WiFi",
                        CategoryId=(int)CategoryEnum.Motherboards,
                ...
                var fanProducts = new List<Product>
                {
                    new() { Name="Zalman CNPS13X Black",
                        CategoryId=(int)CategoryEnum.Fans,
                ...
                var mouseProducts = new List<Product>
                {
                    new() { Name="Lenovo Yoga Pro",
                        CategoryId=(int)CategoryEnum.Mouse,
                ...
                var keyboardProducts = new List<Product>
                {
                    new() { Name="Keychron K10 HE Standart Version Black K10H-J1-RU (Nebula Magnetic)",
                        CategoryId=(int)CategoryEnum.Keyboards,
                ...
                var laptopProducts = new List<Product>
                {
                    new() { Name="Lenovo Legion 5 15AHP10",
                        CategoryId=(int)CategoryEnum.Laptops,
                ...
                var ssdProducts = new List<Product>
                {
                    new() { Name="ADATA Legend 900 Pro 1TB SLEG-900P-1TCS",
                        CategoryId=(int)CategoryEnum.SSD,
                ...
                var hddProducts = new List<Product>
                {
                    new() { Name="WD Purple 1TB [WD10PURZ]",
                        CategoryId=(int)CategoryEnum.HDD,
